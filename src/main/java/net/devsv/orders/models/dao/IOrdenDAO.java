...
public interface IOrdenDAO extends CrudRepository<Orden,Integer> {
	@Query("FROM Orden o WHERE o.estado = 'R' ORDER BY o.fechaOrden")
	List<Orden> FindAllRecibidas();
	
	@Query("FROM Orden o WHERE o.estado = 'D' ORDER BY o.fechaOrden")
	List<Orden> FindAllDespachadas();
	
	@Query("FROM Orden o WHERE o.estado = 'A' ORDER BY o.fechaOrden")
	List<Orden> FindAllAnuladas();
	
	@Query("FROM Orden o WHERE o.usuario = :id")
	List<Orden> FindOrdersByUser(@Param("id")Integer id);
	
	@Query("FROM Orden o WHERE o.estado = 'R' AND o.fechaOrden BETWEEN :fechaInicio AND :fechaFinal ORDER BY o.fechaOrden DESC")
	List<Orden> findAllRecibidasWithRangoFechas(@Param("fechaInicio") Date fechaInicio, @Param("fechaFinal") Date fechaFinal);
	
	@Query("FROM Orden o WHERE o.estado = 'D' AND o.fechaOrden BETWEEN :fechaInicio AND :fechaFinal ORDER BY o.fechaOrden DESC")
	List<Orden> findAllDespachadasWithRangoFechas(@Param("fechaInicio") Date fechaInicio, @Param("fechaFinal") Date fechaFinal);
	
	@Query("FROM Orden o WHERE o.estado = 'A' AND o.fechaOrden BETWEEN :fechaInicio AND :fechaFinal ORDER BY o.fechaOrden DESC")
	List<Orden> findAllAnuladasWithRangoFechas(@Param("fechaInicio") Date fechaInicio, @Param("fechaFinal") Date fechaFinal);
